...
INSERT INTO T_AUTHORITY(id, name, parentId, action, dependents, remark) VALUES ('0201', '应收', '02', 'reception/statistics.do,reception/statisticsByOrder.do', '', '拥有应收权限，可以查看应收情况');
