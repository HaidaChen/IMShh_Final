...
INSERT INTO T_AUTHORITY(id, name, parentId, action, dependents, remark) VALUES ('0102', '原材料入库', '01', 'reception/loadreception.do,reception/edit.do,reception/save.do,reception/delete.do,reception/importreception.do,reception/exportreception.do', '', '拥有采购计划权限，可以查看，录入，修改和删除采购计划');
