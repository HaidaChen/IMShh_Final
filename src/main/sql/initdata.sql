...
INSERT INTO T_AUTHORITY(id, name, parentId, action, dependents, remark) VALUES ('0102', '原材料入库', '01', 'materialin/loadmaterialin.do,materialin/findById.do,materialin/save.do,materialin/delete.do,materialin/importmaterialin.do,materialin/exportmaterialin.do', '', '拥有采购计划权限，可以查看，录入，修改和删除采购计划');
INSERT INTO T_AUTHORITY(id, name, parentId, action, dependents, remark) VALUES ('0103', '原材料出库', '01', 'main.do', NULL, '');
INSERT INTO T_AUTHORITY(id, name, parentId, action, dependents, remark) VALUES ('0104', '成品入库', '01', 'storage/loadstorage.do,storage/save.do,storage/edit.do,storage/delete.do,storage/importstorage.do,storage/exportstorage.do,storage/loadstatistics.do', '', '拥有入库单权限，可以查看，录入，修改和删除入库单');
...
INSERT INTO T_AUTHORITY(id, name, parentId, action, dependents, remark) VALUES ('0403', '产品信息', '04', 'pdt/loadpdt.do,pdt/save.do,pdt/loadallpdt.do,pdt/findbycode.do,pdt/edit.do,pdt/delete.do,pdt/importproduct.do,pdt/exportproduct.do', '', '拥有产品信息权限，可以查看，录入，修改和删除产品信息');
