...
INSERT INTO `t_authority` VALUES ('0101', '订单', '01', 'order/loadorder.do,order/loadallorder.do,order/findById.do,order/findbyidentify.do,order/finddetailbyid.do,,order/save.do', '', '拥有订单管理权限，可以查看，录入，修改和删除订单');
...
INSERT INTO `t_authority` VALUES ('0103', '发货单', '01', 'deliver/loaddeliver.do,deliver/edit.do,deliver/save.do,deliver/findbyorder.do,deliver/loadbycust.do,deliver/delete.do,deliver/importdeliver.do,deliver/exportdeliver.do', '', '拥有发货单权限，可以查看，录入，修改和删除发货单');
